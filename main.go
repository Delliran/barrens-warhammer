...
func loadConfig() (*Config, error) {
	...
	viper.SetDefault("prompt", []string{
		...
		"Ответь как смертельно уставный и циничный имперский гвардеец из окопов Враки 3 но не больше 50 слов в ответе. Пусть в ответе будет обреченность, ненависть к вышестоящим и тоска по дому.",
