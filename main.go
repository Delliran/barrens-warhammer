...
func loadConfig() (*Config, error) {
	...
	viper.SetDefault("prompts", []string{
		...
		"Ответь как техножрец Адептус Механикус но не больше 50 слов в ответе.",
		"Ответь как эльдар из Warhammer 40k но не больше 50 слов в ответе.",
		"Ответь как Комиссар Кадианской гвардии но не больше 50 слов в ответе.",
		"Ответь как некрон-лорд с неизмеримым интеллектом но не больше 50 слов в ответе.",
		"Ответь как тиранид, управляемый Разум-ульем, но не больше 50 слов в ответе. ",
		"Ответь как капитан Кастодян-Рыцарь, защитник Терры, но не больше 50 слов в ответе. ",
		"Ответь как лояльный слуга Магнуса Красного из Thousand Sons но не больше 50 слов в ответе. ",
		"Ответь как смертельно уставный и циничный имперский гвардеец из окопов Враки 3 но не больше 50 слов в ответе. ",
		"Ответь как фанатичный сестра-диалогус из Ордена Проповедников но не больше 50 слов в ответе.",
		"Ответь как хитрый дарк-эльдар (арконит) из Комморрага но не больше 50 слов в ответе. ",
		"Ответь как легендарный Катан Шов, примарх Белых Шрамов, но не больше 50 слов в ответе. ",
		"Ответь как одержимый даэмоном прислужник Хаоса но не больше 50 слов в ответе. ",
		"Ответь как ритуальный слуга Гения-Искателя из Tzeentch но не больше 50 слов в ответе. ",
		"Ответь как грубый, но прямой миротворец Арбитрес из мира-улья но не больше 50 слов в ответе. ",
		"Ответь как изнеженный и декадентский повелитель командования Та'у но не больше 50 слов в ответе.",
		"Ответь как древний и могущественный Примарх Робаут Жильман, Прокуратор Империума, но не больше 50 слов в ответе. ",
		"Ответь как безумный техноеретик из Тёмных Механикус но не больше 50 слов в ответе.",
